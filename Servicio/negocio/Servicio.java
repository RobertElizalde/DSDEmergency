...
public class Servicio
{
  ...
  public Response alta(@FormParam("usuario") Usuario usuario) throws Exception
  {
      ...
      if (usuario.foto != null)
      {
        ...
        finally
        {
          stmt_3.close();
			...
			PreparedStatement stmt_4 = conexion.prepareStatement("SELECT id_usuario FROM usuarios WHERE email=?");
					try
				  {
				    stmt_4.setString(1,usuario.email);
    ...
    return Response.ok().entity(j.toJson(usuario)).build();
  }
  ...
  @Consumes(MediaType.APPLICATION_FORM_URLENCODED)
  @Produces(MediaType.APPLICATION_JSON)
  public Response consulta(@FormParam("id_usuario") String id) throws Exception
  {
    Connection conexion= pool.getConnection();
  ...
  public Response modifica(@FormParam("usuario") Usuario usuario) throws Exception
  {
    ...
    try
    {
      ...
      try
      {
        ...
        stmt_1.setString(7,usuario.id_usuario);
      ...
      if (usuario.foto != null)
      {
        ...
        try
        {
          stmt_2.setString(1,usuario.id_usuario);
          stmt_2.executeUpdate();
        }
        finally
        {
        ...
        {
          stmt_3.setBytes(1,usuario.foto);
          stmt_3.setString(2,usuario.id_usuario);
          stmt_3.executeUpdate();
        }
        finally
        {
  ...
  @Consumes(MediaType.APPLICATION_FORM_URLENCODED)
  @Produces(MediaType.APPLICATION_JSON)
  public Response borra(@FormParam("id_usuario") String id) throws Exception
  {
    Connection conexion= pool.getConnection();
